...
function Dcomapp() {
    ...
    const getCompletedAppointments = useCallback(async () => {
        setLoading(true);
        try {
            ...
            <div className="flex p-4 h-[92vh] bg-green-50">
                ...
                <div className="w-10/12 ml-auto bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col">
                    ...
                    <div className="bg-green-100 p-4 border-b border-green-200">
                        <h4 className='text-2xl font-bold text-green-800 text-center'>Completed Appointments</h4>
                    </div>
                    ...
                    <div className="p-6 flex-grow overflow-y-auto">
                        <div className="overflow-x-auto">
                            {loading ? (
                                        ...
                                        {appointments.map((app, i) => (
                                            <tr key={app._id} className="border-b border-gray-200 hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-3">
                                                    <span className="px-3 py-1 text-sm font-semibold rounded-full bg-blue-200 text-blue-900">
                                                        {app.status}
                                                    </span>
                                                </td>
                                            </tr>
                                ...
                                <p className="text-center text-gray-500 mt-8">No completed appointments found.</p>
                            )}
                        </div>
                    </div>
                </div>
