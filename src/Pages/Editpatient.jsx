...
function Editpatient() {
    ...
    useEffect(() => {
        ...
        if (!isAdminLoggedIn) {
            ...
            const getPatientData = async () => {
                try {
                    const response = await axios.get(`${import.meta.env.VITE_API_URL}/patient/${patientId}`);
    ...
    const handleUpdatePatient = async (e) => {
        ...
        try {
            const response = await axios.put(`${import.meta.env.VITE_API_URL}/patient/${patientId}`, patientData);
            if (response.data.msg === "Success") {
